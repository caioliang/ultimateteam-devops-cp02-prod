...
# westus
# westus2
export RESOURCE_GROUP_NAME="rg-ultimateteam"
export WEBAPP_NAME="ultimateteam-java"
export APP_SERVICE_PLAN="planUltimateteam"
...
az webapp config appsettings set \
  ...
  --settings \
    ...
    SPRING_DATASOURCE_USERNAME="ultimateteam" \
    SPRING_DATASOURCE_PASSWORD="ultimateteam@slorr2" \
    SPRING_DATASOURCE_URL="jdbc:sqlserver://msqlserver-ultimateteam-teste-1.database.windows.net:1433;database=ultimateteam-db-teste-1;user=admlca@msqlserver-ultimateteam-teste-1;password={your_password_here};encrypt=true;trustServerCertificate=false;hostNameInCertificate=*.database.windows.net;loginTimeout=30;"
